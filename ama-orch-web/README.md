...
```
src/main/java/com/amaorchnsuaru/manager/
├── lesson/LessonApplication.java              # メインクラス
├── controller/
...
- `GET /web/rehearsal` - SRT解析フォーム
- `POST /web/rehearsal/analyze` - SRTファイル解析
- `GET /web/rehearsal/download/json` - JSON出力
- `GET /web/rehearsal/download/csv` - CSV出力
- `GET /web/rehearsal/download/excel` - Excel出力
- `GET /web/rehearsal/download/pdf` - PDF出力
